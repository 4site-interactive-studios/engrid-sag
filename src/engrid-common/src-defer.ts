...
export class SrcDefer {
  ...
  constructor() {
    ...
    for (let i = 0; i < this.videoBackground.length; i++) {
      let video = this.videoBackground[i] as any;
      ...
      let videoBackgroundSourcedDataSrc = this.videoBackgroundSource[
        i
      ...
      if (videoBackgroundSource) {
        for (let i = 0; i < this.videoBackgroundSource.length; i++) {
          ...
          if (videoBackgroundSourcedDataSrc) {
            this.videoBackgroundSource[i].setAttribute(
              "src",
              videoBackgroundSourcedDataSrc
            );
            this.videoBackgroundSource[i].setAttribute(
          ...
          if (videoBackgroundParent && copyOfVideoBackground) {
            videoBackgroundParent.replaceChild(
              copyOfVideoBackground,
              this.videoBackground[i]
            ); // Replace the <video> with the copy of itself
