...
document.onreadystatechange = () => {
  if (document.readyState === "complete") {
    ...
    let enFieldMobilePhone = document.querySelectorAll(
      "input#en__field_supporter_NOT_TAGGED_42"
    )[0];
    ...
    // Add placeholder to the Mobile Phone Field
    let enFieldTransactionComments = document.querySelectorAll(
      "textarea#en__field_transaction_comments"
    )[0];
    ...
    let enFieldBankAccountNumber = document.querySelectorAll(
